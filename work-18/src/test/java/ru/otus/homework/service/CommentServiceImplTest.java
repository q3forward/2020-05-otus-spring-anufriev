...
class CommentServiceImplTest {
    ...
    void findByIdTest() {
        ...
        given(repo.findById(anyLong())).willReturn(comment);
    ...
    void addTest() {
        ...
        Comment actual = service.add(book, "Comment text");
        assertThat(actual)
                .isNotNull()
    ...
    void updateTest() throws CommentNotFoundException {
        long id = 1;

        Optional<Comment> oldComment = Optional.of(new Comment(1L, "Comment text", book));
        given(repo.findById(anyLong())).willReturn(oldComment);

        String newText = "New text";
        service.update(id, book, newText);
